...
asm.prototype.toString = function() {
  ...
  // just for debugging call system call 4(write)
  this.source += this.trySyscall(syscall.unlink, '/opt/asm-test.sample');
  this.source += this.trySyscall(syscall.write, 'Hello worldhdjsahdjs', 0x01);
